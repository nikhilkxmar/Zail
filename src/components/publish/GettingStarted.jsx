    ...
    <div className='mt-4'>
        <div className='w-full'>
            ...
            <div className='bg-[#bedbed] rounded-[7px] px-12 py-8 mt-[12px]'>
                ...
                <div className='flex justify-center items-start mt-[33px]'>
                    <div className='mt-[7px]'><GoNorthStar className='w-[20px] h-[20px] pointer-events-none'/></div>
                    <p className='font-playfair text-gray-800 text-[20px] ml-[25px]'>{'Your audio file is the heart of your audiobook. Allow users to upload their carefully crafted narrative, bringing their characters and worlds to life with their voices. Supported by our platforms accepted file formats, your audio file will become an integral part of the immersive audiobook experience.'}</p>
                </div>
                <div className='flex justify-center items-start mt-[33px]'>
                    <div className='mt-[7px]'><GoNorthStar className='w-[20px] h-[20px] pointer-events-none'/></div>
                    <p className='font-playfair text-gray-800 text-[20px] ml-[25px]'>{'To enhance discoverability, provide metadata such as language, narrators, and relevant tags. Enable potential listeners and collectors to find your audiobook effortlessly within our platforms extensive library.'}</p>
                </div>
            </div>
        </div>
    </div>
