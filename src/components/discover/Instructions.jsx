              ...
              <div className='bg-white rounded-[5px] shadow-sm border-[1.75px] border-black'>
                  <div className='p-4 pb-8'>
                    ...
                    <h3 className='font-medium font-playfair text-[22px] my-6 text-center'>{'Search'}</h3>
                      <p className='text-gray-600 font-playfair text-[19px] text-center'>{'Discover audiobooks from your favorite authors on our decentralized platform. Use the search function to find authors by address and explore their collection of captivating audiobooks. Whether youre a fan of mystery, romance, or science fiction, searching by author allows you to easily access their works and embark on exciting audio adventures.'}</p>
                  </div>
              </div>
              <div className='bg-white rounded-[5px] shadow-sm border-[1.75px] border-black'>
                  <div className='p-4 pb-8'>
