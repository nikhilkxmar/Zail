...
const Nft = (props) => {
  return (
    <div className='max-w-[1240px] my-[100px]'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-x-8 px-4 pt-6 pb-[120px] text-black bg-white rounded-b-[7px] mt-[0px] border-[2px] border-gray-900'>
            {
            props.nfts.map(nft => (
                    nft.list ? <></> : 
                    <div key={nft.id} className='relative bg-gray-200 text-center shadow-md cursor-pointer'>
